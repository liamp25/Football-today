...
if(!function_exists('get_btts_yes_or_no')){
    function get_btts_yes_or_no($score){
        $btts_yes_array = [
            "1:0" => "No",
            "2:0" => "No",
            "3:0" => "No",
...
if(!function_exists('get_u25_or_o25')){
    function get_u25_or_o25($score){
...
if(!function_exists('get_1x2')){
    function get_1x2($score){
