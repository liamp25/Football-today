                        ...
                        <div class="card-body">
                            <div class="row justify-content-center">
                                <div class="col-md-3 text-center mobile-resp">
                                    <a class="no-underline team-link"
                                                    ...
                                                    @forelse ($form["home"] as $home_fixture)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="white-space: nowrap; centered-links"
                                                                ...
                                                                <p><a href="{{ route('public.fixture.match-info.get', $home_fixture->fixture->id) }}"
                                                                        class="btn btn-sm btn-secondary"
                                                                        title="Match-Info">Match Info</a></p>
                                                                <p><a href="{{ route('public.fixture.match-preview.get', $home_fixture->fixture->id) }}"
                                                                        class="btn btn-sm btn-secondary"
                                                                        title="Match-Info">Match Preview</a></p>
                                                            </td>
                                                            <td class="text-right">
                                                                <a class="no-underline"
                                                                    href="{{ route('public.team.get', [
                                                    ...
                                                    @forelse ($form["away"] as $away_fixture)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="white-space: nowrap; centered-links"
                                                                ...
                                                                <p><a href="{{ route('public.fixture.match-info.get', $away_fixture->fixture->id) }}"
                                                                        class="btn btn-sm btn-secondary"
                                                                        title="Match-Info">Match Info</a></p>
                                                                <p><a href="{{ route('public.fixture.match-preview.get', $away_fixture->fixture->id) }}"
                                                                        class="btn btn-sm btn-secondary"
                                                                        title="Match-Info">Match Preview</a></p>
                                                            </td>
                                                            <td class="text-right">
                                    ...
                                    @forelse ($h2h as $h2h_single)
                                        ...
                                        <tr>
                                            ...
                                            <td style="white-space: nowrap centered-links" align="center">
                                                ...
                                                <p><a href="{{ route('public.fixture.match-info.get', $h2h_single->fixture->id) }}"
                                                        class="btn btn-sm btn-secondary" title="Match-Info">Match
                                                        Info</a></p>
                                                <p><a href="{{ route('public.fixture.match-preview.get', $h2h_single->fixture->id) }}"
                                                        class="btn btn-sm btn-secondary" title="Match-Info">Match
                                                        Preview</a></p>
                                            </td>
                                            <td class="text-right">
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="card">
                                <div class="card-body table-responsive" id="accordionExample">
                                    ...
                                    {{--  --}}
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-goals-total"
                                            data-toggle="collapse" data-target="#collapse-top-goals-total"
                                            aria-expanded="true" aria-controls="collapse-top-goals-total">
                                            Top Goals Total
                                        </div>

                                        <div id="collapse-top-goals-total" class="collapse"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-goals-assists"
                                            data-toggle="collapse" data-target="#collapse-top-goals-assists"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-shots-total"
                                            data-toggle="collapse" data-target="#collapse-top-shots-total"
                                            aria-expanded="true" aria-controls="collapse-top-shots-total">
                                            Top Shots Total
                                        </div>

                                        <div id="collapse-top-shots-total" class="collapse"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-shots-on"
                                            data-toggle="collapse" data-target="#collapse-top-shots-on" aria-expanded="true"
                                            aria-controls="collapse-top-shots-on">
                                            Top Shots On
                                        </div>

                                        <div id="collapse-top-shots-on" class="collapse"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-games-rating"
                                            data-toggle="collapse" data-target="#collapse-top-games-rating"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-passes-key"
                                            data-toggle="collapse" data-target="#collapse-top-passes-key"
                                            aria-expanded="true" aria-controls="collapse-top-passes-key">
                                            Top Passes Key
                                        </div>

                                        <div id="collapse-top-passes-key" class="collapse"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-tackles-total"
                                            data-toggle="collapse" data-target="#collapse-top-tackles-total"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-fouls-committed"
                                            data-toggle="collapse" data-target="#collapse-top-fouls-committed"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-cards-yellow"
                                            data-toggle="collapse" data-target="#collapse-top-cards-yellow"
                        ...
                        <div class="col-md-6 mb-2">
                            ...
                            <div class="card">
                                <div class="card-body table-responsive" id="accordionExample2">
                                    {{--  --}}
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-goals-total2"
                                            data-toggle="collapse" data-target="#collapse-top-goals-total2"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-goals-assists2"
                                            data-toggle="collapse" data-target="#collapse-top-goals-assists2"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-shots-total2"
                                            data-toggle="collapse" data-target="#collapse-top-shots-total2"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-shots-on2"
                                            data-toggle="collapse" data-target="#collapse-top-shots-on2" aria-expanded="true"
                                            aria-controls="collapse-top-shots-on2">
                                            Top Shots On
                                        </div>

                                        <div id="collapse-top-shots-on2" class="collapse"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-games-rating2"
                                            data-toggle="collapse" data-target="#collapse-top-games-rating2"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-passes-key2"
                                            data-toggle="collapse" data-target="#collapse-top-passes-key2"
                                            aria-expanded="true" aria-controls="collapse-top-passes-key2">
                                            Top Passes Key
                                        </div>

                                        <div id="collapse-top-passes-key2" class="collapse"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-tackles-total2"
                                            data-toggle="collapse" data-target="#collapse-top-tackles-total2"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-fouls-committed2"
                                            data-toggle="collapse" data-target="#collapse-top-fouls-committed2"
                                    ...
                                    <div class="card mt-2">
                                        <div class="player-stats card-header" id="heading-top-cards-yellow2"
                                            data-toggle="collapse" data-target="#collapse-top-cards-yellow2"
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <small class="card-text my-2">
                                                        ...
                                                        matches drawn
                                                        <strong>{{ $team_statistics['home']->fixtures->draws->home }}</strong>
                                                        and
                                                        lost
                                            ...
                                            <div class="card">
                                                <div class="card-body">
                                                    ...
                                                    <small class="card-text my-2">
                                                        ...
                                                        matches drawn
                                                        <strong>{{ $team_statistics['away']->fixtures->draws->away }}</strong>
                                                        and
                                                        lost
