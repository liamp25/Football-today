            ...
            <nav>
                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                    <a class="nav-item nav-link active" id="nav-overview-tab" data-toggle="tab"
                        href="#nav-overview{{ $fixture->id }}" role="tab" aria-controls="nav-overview"
                        aria-selected="true">overview</a>
                    <a class="nav-item nav-link navstatstab" id="nav-stats-tab-main" data-id="{{ $fixture->id }}"
                        data-route="{{ route('public.teamstats', ['id' => $league->id, 'season' => $league->season, 'home_id' => $teams->home->id, 'away_id' => $teams->away->id]) }}"
                        data-toggle="tab" href="#nav-stats{{ $fixture->id }}" role="tab"
                        aria-controls="team-stats" aria-selected="true">Team Stats</a>
                    <a class="nav-item nav-link" id="nav-match-tab" data-toggle="tab"
                        href="#nav-match{{ $fixture->id }}" role="tab" aria-controls="nav-match"
                        aria-selected="false">match Center</a>
                    <a class="nav-item nav-link" id="nav-lineups-tab" data-toggle="tab"
                        href="#nav-lineups{{ $fixture->id }}" role="tab" aria-controls="nav-lineups"
                        aria-selected="false">lineups</a>
                </div>
            </nav>
            <div class="tab-content py-3 px-3 px-sm-0" id="nav-tabContent">

                <!-- overview tab content -->
                <div class="tab-pane fade show active" id="nav-overview{{ $fixture->id }}" role="tabpanel"
                ...
                <div class="tab-pane fade show" id="nav-stats{{ $fixture->id }}" role="tabpanel"
                    aria-labelledby="nav-stats-tab-main">
                ...
                <div class="tab-pane fade" id="nav-match{{ $fixture->id }}" role="tabpanel"
                                                            ...
                                                            @else
                                                                <td class="text-right">
                                                                    <span style="display: inline-block">
                                                                        ...
                                                                        <span
                                                                            class="text-xs text-muted">{{ $event->time->elapsed }}'</span>&nbsp;
                                                                        <i class="far fa-futbol text-success"></i>
                                                                    </span>
                                                                </td>
                                                            @endif
                                                                    ...
                                                                    <td class="text-left">
                                                                        <span style="display: inline-block">
                                                                            <svg width="16" height="16"
                                                                                viewBox="180 180 680 680" fill="#404040"
                                                                                style="min-width: 16px; display: inline-block;">
                                                                                <title>2nd Yellow card (Red)</title>
                                                                                <path fill="#ecaa02"
                                                                                    d="M243.2 275.2h428.8v588.8h-428.8v-588.8z">
                                                                                </path>
                                                                                <path fill="#a72018"
                                                                                    d="M352 160h428.8v588.8h-428.8v-588.8z"></path>
                                                                            </svg>&nbsp;
                                                                            <span
                                                                                class="text-xs text-muted">{{ $event->time->elapsed }}'</span>&nbsp;
                                                                            {{ $event->player->name }}
                ...
                <!-- lineups tab content -->
                <div class="tab-pane fade" id="nav-lineups{{ $fixture->id }}" role="tabpanel"
                    aria-labelledby="nav-lineups-tab">
                    {{-- Lineups --}}
                    <div class="mb-2">
                        <div class="card align-middle bg-dark text-white">
                                ...
                                <table class="table" style="width: 100%;">
                                    <thead>
                                        <th colspan="2"
                                            ...
                                            {{ $teams->home->name }} |
                                            {{ !empty($lineups) ? $lineups[0]->formation : '-' }}
                                        </th>
                                        <th colspan="2" style="width:50%">
                                            {{ $teams->away->name }} |
                                            {{ !empty($lineups) ? $lineups[1]->formation : '-' }}
                                        </th>
                                    </thead>
                                    <tbody>
                                        @if (!empty($lineups))
...
<div class="match__list_footer">
    <a href="#" class="match-preview-btn" data-id="{{ $fixture->id }}" type="button"
        data-toggle="collapse" data-target="#match_preivew{{ $fixture->id }}"> Match preview ❯ </a>
</div>
