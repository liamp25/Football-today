...
<div class="content">
    <div class="row align-items-center p-0 m-0">
        ...
        <div class="col-md-6 text-right p-0 m-0">
            <div class="breadcrumb-wrapper">
                <a href="{{url('admin/add-plan')}}" class="btn btn-primary">
                    <span class="fa fa-plus-circle"></span> Add Plan
                </a>
            </div>
        </div>
    </div>
...
<script>
    ...
    $(".delete-data").on('click', function () {
        ...
        $.confirm({
            title: 'Are you sure?',
            content: 'This will delete this membership permanently',
            buttons: {
                confirm: {
                    btnClass: 'btn-blue',
                    action: function () {
